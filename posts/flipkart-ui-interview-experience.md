...
In general, interviewers were quite helpful in all the rounds. Internally, they have a option to reject any candidate immediately after their round (if it went really bad). 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg5NTE4NDIzNSwtOTcwODAyMTU0LDE2ND
A0MzI1ODRdfQ==
-->