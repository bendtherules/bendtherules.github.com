...
Example task -  Consider a todo app. You can add, edit, remove items. Allow sub-items within a existing item. There might be some form validation 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMjU3MTk5ODQsLTk3MDgwMjE1NCwxNj
QwNDMyNTg0XX0=
-->