...
Now, remember `F.[[ThisMode]]` (stored in function object) and the FunctionEnvironment ( created when the function was called?

### Types of environments


<!--stackedit_data:
eyJoaXN0b3J5IjpbMjA3NTYyOTYxLDE5NzAwODU2OTQsLTM3OT
