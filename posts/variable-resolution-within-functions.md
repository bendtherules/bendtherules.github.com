...
These two methods are implemented on all types of environment (scope). We saw what Function Environment returns Global environment 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM4Mjc0NjAxLDE2MjE2MTE2OTQsLTExMj
