...
A function has 2 distinct phases - function creation and function call.  A function can be created/defined in a scope (say, creation scope), stored and called later in a different scope (caller scope). 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2NjIzMTY5NTYsLTg5OTYzODE3MSwyMD
