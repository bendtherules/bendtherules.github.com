...
A function has 2 distinct phases - function creation and function call.  Function is created when you define it (with hoisting) and that scope can be called as lexical scope or creation scope. can be created/defined in a scope (say, creation scope), stored and called later in a different scope (caller scope). 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3MDM0MTYyNDgsLTE2NjIzMTY5NTYsLT
