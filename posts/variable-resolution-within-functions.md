...
When a function `F` is being created, it stores a few internal properties. Two of them are importnat for this understanding.

* It stores the current scope (creation scope) in `F.[[Environment]]`. This is a internal property, not generally visible to users.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI1MTcwNzQwMiwxNDc5ODcyMTU3LDgwMD
