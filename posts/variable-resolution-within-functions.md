...
A function has 2 distinct phases - function creation and function call.  Function is created when you define it can be created/defined in a scope (say, creation scope), stored and called later in a different scope (caller scope). 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NDEzOTcyODQsLTE2NjIzMTY5NTYsLT
