...
All these sounds obvious, but it's easy to forget the difference. So, let's actually see them in our previous code snippet -
```js
function outer() {
  // scope A
  var text = 'Hello'
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNjk2Mzg0MzUsLTE2NjIzMTY5NTYsLT
