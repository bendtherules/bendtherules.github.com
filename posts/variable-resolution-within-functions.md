...
A function has 2 distinct phases - function creation and function call.  A function can be created/defined in a scope, stored in a variable and called later in a different scope. 
 It sounds obvious, but it's easy to forget the difference. Looking at our prev code snippet again, we will mark the create and call phase and their corresponding scopes.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg2NTM4MDA0OSwtODk5NjM4MTcxLDIwNz
