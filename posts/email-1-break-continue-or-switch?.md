...
It has a variable called `labelset` - which contains the list of labels for the current for loop. Now, after for loop executes the body of the loop
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY5ODUxNjU1NywtNjYyNjMxNzgzLC02Nj
