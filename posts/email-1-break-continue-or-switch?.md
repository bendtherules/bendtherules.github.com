...
Just to repeat, for `continue;` - the loop body skips the rest of the statements, because it is a abrupt completion. Then , 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMxMjM2NzczNSwtMTU5NjEyNzYwLDE3OT
