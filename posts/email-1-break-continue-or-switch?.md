...
```
As you can see, using **break with a label** lets us exit out of multiple loops at once. Using just `break;` will only exit from the current loop.   
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzMTIzOTgyMywtNjYyNjMxNzgzLC02Nj
