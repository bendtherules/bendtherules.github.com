...
⚠️  It just looks like the `name` property holds the name of the variable it created. ()**Are they even different?**
...
BnZm1cbiIsImhpc3RvcnkiOls5OTAwNTU4MzgsLTIwMDg3NzU3
