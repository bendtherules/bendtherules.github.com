...
When you write a function, you are (often) not declaring a var/let/const yourself. So, how exactly does the engine create this variable internally which points to the function? That's all this article is about.
...
BnZm1cbiIsImhpc3RvcnkiOlstMTU5NDU1ODg3MywtMTI3Mzk5
