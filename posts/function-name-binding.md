...
Because there is **no named arrow function syntax**, this is very useful to create a arrow function which has a name. That means, you can't create a named arrow function like this - `hello() => {}`, only way is to use `hello = () => {}`
...
BnZm1cbiIsImhpc3RvcnkiOlsxOTY5MjExNDAwLC03NzM2NjA2
