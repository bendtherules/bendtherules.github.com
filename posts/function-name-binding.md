...
>  
> The short answer is, **hoisting**. There is a (sort of) *"pre-evaluation"* step and then a actual *"evaluation"* step for all statements. 
> 
> 
...
BnZm1cbiIsImhpc3RvcnkiOlstNzI1MjE5Mzk3LDIwNTY0NzIz
